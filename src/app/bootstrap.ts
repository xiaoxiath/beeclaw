 ...
 *
 * Contains the main initApp() function and all application initialization logic
 * including configuration loading, provider setup, agent creation, and plugin loading.
 */
...
// Registry (shared app state)
import { appState, getTokenStatsConfig } from './registry';
