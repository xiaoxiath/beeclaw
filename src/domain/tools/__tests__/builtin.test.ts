...
describe('Builtin Tools', () => {
  ...
  describe('taskCreateTool', () => {
    test('has correct structure', () => {
      ...
      expect(taskCreateTool.parameters).toBeDefined();
    });
  });

  describe('executeTaskCreate', () => {
    test('creates search task', async () => {
    ...
    test('creates reminder task', async () => {
      const result = await executeTaskCreate({
        type: 'reminder',
        action: 'remind',
        params: {
    ...
    test('returns error for missing required fields', async () => {
      const result = await executeTaskCreate({ type: 'search' });
      expect(result.success).toBe(false);
    });
  });
  ...
  describe('TaskStatusSchema', () => {
    test('validates correct input', () => {
      const result = TaskStatusSchema.safeParse({ job_id: 'job-123' });
      expect(result.success).toBe(true);
    });
  });
  ...
  describe('taskStatusTool', () => {
    test('has correct structure', () => {
      expect(taskStatusTool.name).toBe('task_status');
      expect(taskStatusTool.description).toBeDefined();
      expect(taskStatusTool.parameters).toBeDefined();
    });
  });

  describe('executeTaskStatus', () => {
    test('returns error for non-existent task', async () => {
      const result = await executeTaskStatus({ job_id: 'non-existent-job' });
      expect(result.success).toBe(false);
    });
  });
  ...
  describe('taskListTool', () => {
    test('has correct structure', () => {
      ...
      expect(taskListTool.parameters).toBeDefined();
    });
  });
  ...
  describe('TaskCancelSchema', () => {
    test('validates correct input', () => {
      const result = TaskCancelSchema.safeParse({ job_id: 'job-123' });
      expect(result.success).toBe(true);
    });
  });
  ...
  describe('taskCancelTool', () => {
    test('has correct structure', () => {
      ...
      expect(taskCancelTool.description).toBeDefined();
      expect(taskCancelTool.parameters).toBeDefined();
    });
  });

  describe('executeTaskCancel', () => {
    test('returns error for non-existent task', async () => {
      const result = await executeTaskCancel({ job_id: 'non-existent-job' });
      expect(result.success).toBe(false);
    });
  });
});
