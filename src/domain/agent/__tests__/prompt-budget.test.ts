...
describe('prompt-budget', () => {
  ...
  describe('LAYER_PRIORITIES', () => {
    ...
    it('maintains ordering: CORE > RUNTIME > TRAITS > SOUL > USER_CONTEXT > SKILLS > FACTS > EXAMPLES', () => {
      ...
      expect(LAYER_PRIORITIES.USER_CONTEXT).toBeGreaterThan(LAYER_PRIORITIES.SKILLS);
